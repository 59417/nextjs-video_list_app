    ...
    <Fragment>
      ...
      <div className={classes.body}>
        ...
        <div className={classes.videos_container}>
            {/* <ListContainer list_state={'All'} filtered={'series'} fetch_data={props.fetchData}/> */}
            <ListContainer list_state={'All'} filtered={'series'} fetch_data={props.fetchData} favs_data={favsData} />
